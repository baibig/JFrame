...
import com.huangjian.jframe.utils.adapter.JListAdapter;
...
public class ListTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new MyAdapter(mData, ListTestActivity.this);
        mRecyclerView.setAdapter(myAdapter);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(ListTestActivity.this));
    }
        ...
        public void onBind(JRecyclerViewAdapter<MyDataModel>.InnerViewHolder holder, final int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(ListTestActivity.this, "Clicked position " + position, Toast.LENGTH_SHORT).show();
                }
            });
        }
